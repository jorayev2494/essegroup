...
namespace Project\Domains\Student\University\Domain\Aplication\Services;

use Project\Domains\Student\University\Application\Application\Commands\Create\Command;
        ...
        return $queryBus->ask(
            \Project\Domains\Admin\University\Application\Application\Queries\Index\Query::makeFromArray(
                array_merge(
                    $query->toArray(),
                    [
                        'student_uuids' => [$studentUuid->value],
                    ]
                )
            )
        );
