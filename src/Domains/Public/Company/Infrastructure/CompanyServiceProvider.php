...
namespace Project\Domains\Public\Company\Infrastructure;

use App\Providers\Domains\AdminDomainServiceProvider;
use Project\Domains\Public\Company\Domain\Company\Services\CompanyService;
...
class CompanyServiceProvider extends AdminDomainServiceProvider
{
    ...
    protected const SERVICES = [
        CompanyServiceInterface::class => [self::SERVICE_SINGLETON, CompanyService::class],
    ];

    /** @var array<array-key, string> */
    protected const QUERY_HANDLERS = [
        \Project\Domains\Public\Company\Application\Company\Queries\List\QueryHandler::class,
    ];
