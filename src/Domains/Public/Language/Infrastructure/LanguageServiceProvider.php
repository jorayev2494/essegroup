...
namespace Project\Domains\Public\Language\Infrastructure;
...
use Project\Domains\Public\Language\Domain\Language\Services\LanguageService;
...
class LanguageServiceProvider extends AdminDomainServiceProvider
{
    ...
    protected const QUERY_HANDLERS = [
        \Project\Domains\Public\Language\Application\Language\Queries\List\QueryHandler::class,
    ];
