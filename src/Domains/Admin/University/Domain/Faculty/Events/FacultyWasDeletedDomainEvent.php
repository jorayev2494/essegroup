...
namespace Project\Domains\Admin\University\Domain\Faculty\Events;

use Project\Shared\Domain\Bus\Event\DomainEvent;

readonly class FacultyWasDeletedDomainEvent extends DomainEvent
{
    ...
    {
        return 'admin_faculty.was.deleted';
    }
