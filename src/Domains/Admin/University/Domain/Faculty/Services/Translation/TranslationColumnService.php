...
namespace Project\Domains\Admin\University\Domain\Faculty\Services\Translation;

use Project\Domains\Admin\University\Domain\Faculty\FacultyTranslation;
    ...
    public function addTranslations(TranslatableInterface $translatable, array $translations): void
    {
        foreach ($translations as $locale => $translates) {
            ...
            foreach ($translates as $translate) {
                $translatable->addTranslation(FacultyTranslation::make($locale, $translate->field, $translate->value));
            }
        }
    }
}
