...
namespace Project\Domains\Admin\University\Infrastructure\Repositories\Doctrine\Faculty\Types;
...
class DescriptionType extends Type
{
    ...
    public const NAME = 'admin_domain_faculty_faculty_description';
