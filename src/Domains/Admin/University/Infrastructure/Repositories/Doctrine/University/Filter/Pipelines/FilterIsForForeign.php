...
class FilterIsForForeign extends BaseFilterPipe
{
    ...
    {
        $queryBuilder->andWhere('u.isForForeign = :isForForeign')
            ->setParameter('isForForeign', $queryFilter->isForForeign);
    }
    ...
    {
        return $queryFilter->isForForeign;
    }
}
