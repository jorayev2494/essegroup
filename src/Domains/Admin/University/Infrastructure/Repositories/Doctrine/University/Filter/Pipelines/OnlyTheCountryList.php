...
class OnlyTheCountryList extends BaseFilterPipe
{
    ...
    {
        $queryBuilder->andWhere('u.isOnTheCountryList = :isOnTheCountryList')
            ->setParameter('isOnTheCountryList', $queryFilter->onlyInCountryList);
    }
    ...
    {
        return $queryFilter->onlyInCountryList;
    }
}
