...
class FilterTopPosition extends BaseFilterPipe
{
    ...
    {
        if ($queryFilter->topPosition == null) {
            $queryBuilder->andWhere('u.topPosition IS NULL');
        } else {
            $queryBuilder->andWhere('u.topPosition IS NOT NULL');
        }
    }
    ...
    {
        return $queryFilter->topPosition !== null;
    }
}
