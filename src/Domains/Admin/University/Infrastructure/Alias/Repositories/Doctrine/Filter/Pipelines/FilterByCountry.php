...
class FilterByCountry extends BaseFilterPipe
{
    ...
    {
        $queryBuilder->innerJoin(Department::class, 'ad_c', Join::WITH, 'ad_c.aliasUuid = a.uuid')
            ->innerJoin(University::class, 'adu_c', Join::WITH, 'adu_c.uuid = ad_c.universityUuid')
            ->andWhere('adu_c.countryUuid IN (:countryUuids)')
