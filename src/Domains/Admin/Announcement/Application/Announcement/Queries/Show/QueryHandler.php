...
namespace Project\Domains\Admin\Announcement\Application\Announcement\Queries\Show;
...
readonly class QueryHandler implements QueryHandlerInterface
{
    ...
    public function __invoke(Query $query): array
    {
        ...
        return AnnouncementTranslate::execute($announcement)->toArrayWithTranslations();
    }
}
