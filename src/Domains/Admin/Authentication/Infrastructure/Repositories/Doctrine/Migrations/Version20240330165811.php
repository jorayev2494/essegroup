 ...
 */
final class Version20240330165811 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE company_statuses (uuid VARCHAR(255) NOT NULL, company_uuid VARCHAR(255) NOT NULL, value VARCHAR(255) NOT NULL, note VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_53670B7C92124A48 (company_uuid), PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE faculty_faculties (uuid VARCHAR(255) NOT NULL, company_uuid VARCHAR(255) DEFAULT NULL, university_uuid VARCHAR(255) DEFAULT NULL, logo_uuid VARCHAR(255) NOT NULL, name VARCHAR(255) DEFAULT NULL, description text DEFAULT NULL, is_active TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_357BE7CFA85ECC4D (logo_uuid), INDEX IDX_357BE7CF92124A48 (company_uuid), INDEX IDX_357BE7CF4C981D05 (university_uuid), PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE university_degrees (uuid VARCHAR(255) NOT NULL, company_uuid VARCHAR(255) DEFAULT NULL, value VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', is_active TINYINT(1) NOT NULL, INDEX IDX_6F95F9B392124A48 (company_uuid), PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE university_departments (uuid VARCHAR(255) NOT NULL, company_uuid VARCHAR(255) DEFAULT NULL, university_uuid VARCHAR(255) DEFAULT NULL, faculty_uuid VARCHAR(255) DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, description text DEFAULT NULL, is_filled TINYINT(1) NOT NULL, is_active TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_6F54A2392124A48 (company_uuid), INDEX IDX_6F54A234C981D05 (university_uuid), INDEX IDX_6F54A235432B5F3 (faculty_uuid), PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE university_universities (uuid VARCHAR(255) NOT NULL, company_uuid VARCHAR(255) DEFAULT NULL, country_uuid VARCHAR(255) DEFAULT NULL, city_uuid VARCHAR(255) DEFAULT NULL, logo_uuid VARCHAR(255) DEFAULT NULL, cover_uuid VARCHAR(255) DEFAULT NULL, youtube_video_id VARCHAR(255) DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, label VARCHAR(255) DEFAULT NULL, description text DEFAULT NULL, is_on_the_country_list TINYINT(1) DEFAULT 0 NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_C0A95993A85ECC4D (logo_uuid), UNIQUE INDEX UNIQ_C0A95993E5A3194F (cover_uuid), INDEX IDX_C0A9599392124A48 (company_uuid), INDEX IDX_C0A95993564CDB42 (country_uuid), INDEX IDX_C0A9599332316DCE (city_uuid), PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE faculty_faculties ADD CONSTRAINT FK_357BE7CF92124A48 FOREIGN KEY (company_uuid) REFERENCES company_companies (uuid) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE university_applications ADD CONSTRAINT FK_D4005ABD92124A48 FOREIGN KEY (company_uuid) REFERENCES company_companies (uuid) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE university_applications ADD CONSTRAINT FK_D4005ABD564CDB42 FOREIGN KEY (country_uuid) REFERENCES country_countries (uuid) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE university_departments ADD CONSTRAINT FK_6F54A2392124A48 FOREIGN KEY (company_uuid) REFERENCES company_companies (uuid) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE university_universities ADD CONSTRAINT FK_C0A9599392124A48 FOREIGN KEY (company_uuid) REFERENCES company_companies (uuid) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE university_universities ADD CONSTRAINT FK_C0A95993564CDB42 FOREIGN KEY (country_uuid) REFERENCES country_countries (uuid) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE university_universities ADD CONSTRAINT FK_C0A9599332316DCE FOREIGN KEY (city_uuid) REFERENCES country_cities (uuid) ON DELETE SET NULL');
