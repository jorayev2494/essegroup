...
readonly class CountryWasChangedIsActiveDomainEvent extends DomainEvent
{
    ...
    public static function fromPrimitives(string $id, array $body, string $eventId, string $occurredOn): DomainEvent
    {
        ...
        return new self($uuid, $isActive, $eventId, $occurredOn);
    }

    #[\Override]
    public static function eventName(): string
    {
        return 'admin_country.was.changed.is_active';
    }
