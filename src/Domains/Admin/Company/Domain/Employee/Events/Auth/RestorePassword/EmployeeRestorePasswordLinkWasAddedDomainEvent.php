...
namespace Project\Domains\Admin\Company\Domain\Employee\Events\Auth\RestorePassword;

use Project\Shared\Domain\Bus\Event\DomainEvent;

readonly class EmployeeRestorePasswordLinkWasAddedDomainEvent extends DomainEvent
{
    ...
    {
        return 'company_employer_forgot_password_code.was.added';
    }
