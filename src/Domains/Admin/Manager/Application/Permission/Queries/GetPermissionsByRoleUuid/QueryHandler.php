...
use Project\Domains\Admin\Manager\Application\Permission\Queries\GetPermissionsByRoleUuid\Query\Output;
...
readonly class QueryHandler implements QueryHandlerInterface
{
    ...
    {
        return Output::make($this->repository->getByRoleUuids($query->roleUuid));
    }
}